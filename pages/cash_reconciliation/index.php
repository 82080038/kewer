...
$reconciliationList = $reconciliationData['success'] && isset($reconciliationData['data']) ? $reconciliationData['data'] : [];
?>
<!DOCTYPE html>
<html lang="id">
<head>
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <?php if ($role === 'manager' || $role === 'karyawan'): ?>
                                ...
                                <tbody>
                                    ...
                                    <tr data-status="<?php echo $rec['status']; ?>" data-tanggal="<?php echo $rec['tanggal']; ?>">
                                        ...
                                        <td>
                                            ...
                                            <?php endif; ?>
                                            <?php if ($rec['status'] === 'submitted' && ($role === 'manager' || $role === 'owner' || $role === 'superadmin')): ?>
