            ...
            <nav class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item"><a class="nav-link" href="../nasabah/index.php"><i class="bi bi-people"></i> Nasabah</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link active" href="index.php"><i class="bi bi-shield-check"></i> Audit Trail</a></li>
                    </ul>
                </div>
            </nav>
