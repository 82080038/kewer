...
// For pusat roles, allow viewing all branches
$report_cabang = in_array($role, $pusat_roles) ? ($_GET['cabang_id'] ?? null) : $cabang_id;

$reportGen = new \Kewer\Reporting\ReportGenerator($report_cabang, $start_date, $end_date);
                    ...
                    <div class="card-body">
                        <form method="GET" class="row g-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="date" name="tanggal_mulai" class="form-control datepicker" value="<?php echo $start_date; ?>">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">Tanggal Selesai</label>
                                <input type="date" name="tanggal_selesai" class="form-control datepicker" value="<?php echo $end_date; ?>">
                            </div>
