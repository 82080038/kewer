...
class KasPetugas {
    ...
    public function createDailyRecord($data) {
        $sql = "INSERT INTO kas_petugas 
                (cabang_id, petugas_id, tanggal, saldo_awal, total_terima, total_disetor, catatan)
                VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public function addCollection($petugasId, $tanggal, $jumlah) {
        ...
        $sql = "SELECT * FROM kas_petugas 
                WHERE petugas_id = ? AND tanggal = ? AND cabang_id = ?";
        
        $record = $this->db->selectOne($sql, [$petugasId, $tanggal, $this->cabangId]);
    ...
    public function getDailyRecord($petugasId, $tanggal) {
        ...
        return $this->db->selectOne($sql, [$petugasId, $tanggal, $this->cabangId]);
    }
    
    /**
     * Get all cash records for a branch
     */
