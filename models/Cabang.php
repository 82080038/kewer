...
class Cabang {
    ...
    public function getById($id) {
        return $this->db->selectOne("
            ...
            FROM cabang c 
            LEFT JOIN db_alamat_simple.provinces p ON c.province_id = p.id
            LEFT JOIN db_alamat_simple.regencies r ON c.regency_id = r.id
            LEFT JOIN db_alamat_simple.districts d ON c.district_id = d.id
            LEFT JOIN db_alamat_simple.villages v ON c.village_id = v.id
            WHERE c.id = ?", [$id]);
    }
